...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/AccountCreation-16d914be.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/DashboardCreate-1100f1a3.mjs').then((m) => m.default || m)
  },
  {
    name: "UserDetails",
    path: "/UserDetails",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/UserDetails-de3037d8.mjs').then((m) => m.default || m)
  }
];
